...
- `~/.clawcode/extensions/*.ts`
- `~/.clawcode/extensions/*/index.ts`
...
- `~/.clawcode/mpm/plugins.json`
- `~/.clawcode/mpm/catalog.json`
- `~/.clawcode/plugins/catalog.json`
...
openclaw plugins install <path>                 # copy a local file/dir into ~/.clawcode/extensions/<id>
...
- `openclaw plugins install <npm-spec>` uses `npm pack`, extracts into `~/.clawcode/extensions/<id>/`, and enables it in config.
