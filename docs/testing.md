...
- Profile store: `~/.clawcode/credentials/` (preferred; what “profile keys” means in the tests)
...
- `OPENCLAW_CONFIG_DIR=...` (default: `~/.clawcode`) mounted to `/home/node/.clawcode`
- `OPENCLAW_WORKSPACE_DIR=...` (default: `~/.clawcode/workspace`) mounted to `/home/node/.clawcode/workspace`
