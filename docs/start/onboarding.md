...
- Writes credentials to `~/.clawcode/credentials/oauth.json`
...
On the first agent run, OpenClaw bootstraps a workspace (default `~/.clawcode/workspace`):
...
- `~/.clawcode/credentials/oauth.json`
