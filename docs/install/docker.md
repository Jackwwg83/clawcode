...
- The gateway container is the source of truth for sessions (`~/.clawcode/agents/<agentId>/sessions/`).
...
- Agent workspace access: `workspaceAccess: "none"` (default) uses `~/.clawcode/sandboxes`
