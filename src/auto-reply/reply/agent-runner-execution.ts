...
export type AgentRunLoopResult =
  | {
      kind: "success";
      runResult: Awaited<ReturnType<typeof runAgentViaSdk>>;
...
export async function runAgentTurnWithFallback(params: {
  ...
  let runResult: Awaited<ReturnType<typeof runAgentViaSdk>>;
      ...
      const fallbackResult = await runWithModelFallback({
        ...
        run: (provider, model) => {
          ...
          return runAgentViaSdk({
            ...
            mcpServers: buildMcpServers({ sessionKey: params.sessionKey }),
